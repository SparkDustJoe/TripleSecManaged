...
namespace Fugue
{
    ref class FugueBase abstract
    {
        protected:
            ...
            virtual array<byte>^ GetResult() abstract;
            virtual void TransformBlocks(array<byte>^ a_data, int a_index, int a_length) abstract;
            ...
            void Finish()
            {
                ...
                m_pad[index] = (byte)(bits);

                TransformBytes(m_pad, 0, 8+need);
            }
        ...
        public:
            ...
            FugueBase(int a_hashSize, int a_blockSize)
            {
                ...
                m_state = gcnew array<uint>(36);
                m_buffer = gcnew Trans::HashBuffer(4);
                m_pad = gcnew array<byte>(12);
    ...
    ref class Fugue256Base abstract : public FugueBase
    {
        protected:

            #pragma region Consts
            static array<ulong>^ aes_style_table0 = 
            {
            ...
            static array<ulong>^ aes_style_table1 = 
            {
            ...
            static array<ulong>^ aes_style_table2 = 
            {
            ...
            static array<ulong>^ aes_style_table3 = 
            {
            ...
            virtual array<byte>^ GetResult() override  
            {
                ...
                return Converters::ConvertUIntsToBytes(result, 0, result->Length);
            }

            virtual void TransformBlocks(array<byte>^ a_data, int a_index, int a_length) override
            {
                array<uint>^ data32 = Converters::ConvertBytesToUInts(a_data, a_index, (a_length / 4) * 4);
    ...
    ref class Fugue224 : public Fugue256Base
    {
        private:

            #pragma region Consts
            static array<uint>^ IV224 = 
            {
        ...
        public:
            ...
            virtual void Initialize() override
            {
                ...
                Array::Copy(IV224, 0, m_state, BlockSize-IV224->Length, IV224->Length);
            }
    };

    ref class Fugue256 : public Fugue256Base
    {
        private:

            #pragma region Consts
            static array<uint>^ IV256 = 
            {
        ...
        public:
            ...
            virtual void Initialize() override
            {
                ...
                Array::Copy(IV256, 0, m_state, BlockSize-IV256->Length, IV256->Length);
            }
    };

    ref class Fugue512Base abstract : public FugueBase
    {
        protected:

            #pragma region Consts
            static array<uint>^ aes_style_table0 = 
            {
            ...
            static array<uint>^ aes_style_table1 = 
            {
            ...
            static array<uint>^ aes_style_table2 = 
            {
            ...
            static array<uint>^ aes_style_table3 = 
            {
            ...
            Fugue512Base(int a_hashSize, int a_blockSize)
                : FugueBase(a_hashSize, a_blockSize)
            {
            }
    };

    ref class Fugue384 : public Fugue512Base
    {
        private:

            #pragma region Consts
            static array<uint>^ IV384 = 
            {
        ...
        protected:
            ...
            virtual void TransformBlocks(array<byte>^ a_data, int a_index, int a_length) override
            {
                array<uint>^ data = Converters::ConvertBytesToUInts(a_data, a_index, (a_length / 4) * 4);
        ...
        public:
            ...
            virtual void Initialize() override
            {
                ...
                Array::Copy(IV384, 0, m_state, BlockSize-IV384->Length, IV384->Length);
            }
    };

    ref class Fugue512 : public Fugue512Base
    {
        private:

            #pragma region Consts
            static array<uint>^ IV512 = 
            {
        ...
        public:
            ...
            virtual void Initialize() override
            {
                ...
                Array::Copy(IV512, 0, m_state, BlockSize-IV512->Length, IV512->Length);
            }
    };
}