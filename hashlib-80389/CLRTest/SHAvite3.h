...
namespace SHAvite3
{
    ref class SHAvite3Base abstract
    {
        #pragma region Consts

        protected: static array<uint>^ Table0 =
        {
        ...
        protected: static array<uint>^ Table1 =
        {
        ...
        protected: static array<uint>^ Table2 =
        {
        ...
        protected: static array<uint>^ Table3 =
        {
    ...
    ref class SHAvite3_256Base : public SHAvite3Base
    {
        #pragma region Consts
        ...
        protected: virtual void TransformBlock(array<byte>^ a_data, int a_index) override
        {
            ...
            array<uint>^ rk = gcnew array<uint>(144);
        ...
        protected: virtual void Finish() override
        {
            array<byte>^ pad = gcnew array<byte>(64);

            Array::Copy(m_buffer, 0, pad, 0, m_buffer_pos);
    ...
    ref class SHAvite3_512Base : public SHAvite3Base
    {
        #pragma region Consts
        ...
        protected: virtual void TransformBlock(array<byte>^ a_data, int a_index) override
        {
            ...
            array<uint>^ rk = gcnew array<uint>(448);
        ...
        protected: virtual void Finish() override
        {
            array<byte>^ pad = gcnew array<byte>(128);
