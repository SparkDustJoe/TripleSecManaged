...
namespace Keccak
{
    ref class Keccak
    {
        ...
        private: array<ulong>^ m_state;
        private: int BlockSize;

        private: void TransformBlock(array<byte>^ a_data, int a_index)
        {
            array<ulong>^ data = Converters::ConvertBytesToULongs(a_data, a_index, BlockSize);
        ...
        private: void Finish()
        {
            ...
            array<byte>^ block = m_buffer->GetBytesZeroPadded();
            block[buffer_pos] = 1;
        ...
        private: array<byte>^ GetResult()
        {
            array<byte>^ state = Converters::ConvertULongsToBytes(m_state, 0, m_state->Length);
            return TomanuExtensions::ArrayExtensions::SubArray(state, 0, HashSize);
        }

        public: int HashSize;

        public: Keccak(int a_hashSize)
        {
            BlockSize = 200 - (a_hashSize * 2);
            HashSize = a_hashSize;

            m_state = gcnew array<ulong>(25);
        ...
        public: void Initialize()
        {
            ...
            m_state[1] = System::UInt64::MaxValue;
            m_state[2] = System::UInt64::MaxValue;
            m_state[8] = System::UInt64::MaxValue;
            m_state[12] = System::UInt64::MaxValue;
            m_state[17] = System::UInt64::MaxValue;
            m_state[20] = System::UInt64::MaxValue;
