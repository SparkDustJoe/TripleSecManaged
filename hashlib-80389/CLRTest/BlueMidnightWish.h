...
{    
    ref class BlueMidnightWishBase abstract
    {
        protected:
            ...
            virtual int GetBufferPos() = 0;
            virtual int BlockSize() = 0;

        public:

            BlueMidnightWishBase(int a_hashSize) : m_hashSize(a_hashSize)
            {
            }
            ...
            void TransformBytes(array<byte>^ a_data, int a_index, int a_length)
            {
                ...
                if (!m_buffer->IsEmpty)
                {
                    ...
                    if (m_buffer->Feed(a_data, a_index, a_length, x))
    ...
    ref class BlueMidnightWish256Base : public BlueMidnightWishBase
    {
        private:

            static array<uint>^ s_initial_state_224 = 
            {   
            ...
            static array<uint>^ s_initial_state_256 = 
            {   
        ...
        protected:
            ...
            {
                array<uint>^ data32 = Converters::ConvertBytesToUInts(a_data, a_index, 64);
            ...
            virtual array<byte>^ GetResult() override
            {
                ...
                array<byte>^ state = Converters::ConvertUIntsToBytes(m_state, 0, m_state->Length);

                if (m_hashSize == 28)
                    Array::Copy(state, 36, result, 0, m_hashSize);
                else
                    Array::Copy(state, 32, result, 0, m_hashSize);
            ...
            virtual void Finish() override
            {
                ...
                if (GetBufferPos() >= 56)
                {
                    TransformBytes(m_pad, 0, 64 - GetBufferPos());
                    Array::Clear(m_pad, 0, 56); // clear()
                }

                m_pad[56-GetBufferPos()] = (byte)bits;
                m_pad[57-GetBufferPos()] = (byte)(bits >> 8);
                m_pad[58-GetBufferPos()] = (byte)(bits >> 16);
                m_pad[59-GetBufferPos()] = (byte)(bits >> 24);
                m_pad[60-GetBufferPos()] = (byte)(bits >> 32);
                m_pad[61-GetBufferPos()] = (byte)(bits >> 40);
                m_pad[62-GetBufferPos()] = (byte)(bits >> 48);
                m_pad[63-GetBufferPos()] = (byte)(bits >> 56);
            ...
            virtual int GetBufferPos() override
            {
                return m_processedBytes % 64;
            }
            virtual int BlockSize() override
            {
                return 64;
            }
        ...
        public:
            ...
            BlueMidnightWish256Base(int a_hashSize)
                : BlueMidnightWishBase(a_hashSize)
            {
                m_buffer = gcnew Trans::HashBuffer(64);

                m_state = gcnew array<uint>(32);
                m_pad = gcnew array<byte>(64);
            ...
            virtual void Initialize() override
            {
                ...
                Array::Clear(m_pad, 0, 64);
            }
    };

    ref class BlueMidnightWish512Base : public BlueMidnightWishBase
    {
        private:

            static array<ulong>^ s_initial_state_384 = 
            {
            ...
            static array<ulong>^ s_initial_state_512 = 
            {
        ...
        protected:
            ...
            virtual void TransformBlock(array<byte>^ a_data, int a_index) override
            {
                array<ulong>^ data64 = Converters::ConvertBytesToULongs(a_data, a_index, 128);

                ulong p512_00 = m_state[0] ^ data64[0];
                ulong p512_01 = m_state[1] ^ data64[1];
                ulong p512_02 = m_state[2] ^ data64[2];
                ulong p512_03 = m_state[3] ^ data64[3];
                ulong p512_04 = m_state[4] ^ data64[4];
                ulong p512_05 = m_state[5] ^ data64[5];
                ulong p512_06 = m_state[6] ^ data64[6];
                ulong p512_07 = m_state[7] ^ data64[7];
                ulong p512_08 = m_state[8] ^ data64[8];
                ulong p512_09 = m_state[9] ^ data64[9];
                ulong p512_10 = m_state[10] ^ data64[10];
                ulong p512_11 = m_state[11] ^ data64[11];
                ulong p512_12 = m_state[12] ^ data64[12];
                ulong p512_13 = m_state[13] ^ data64[13];
                ulong p512_14 = m_state[14] ^ data64[14];
                ulong p512_15 = m_state[15] ^ data64[15];
            ...
            virtual array<byte>^ GetResult() override
            {
                ...
                array<byte>^ state = Converters::ConvertULongsToBytes(m_state, 0, m_state->Length);

                if (m_hashSize == 48)
                    Array::Copy(state, 80, result, 0, m_hashSize);
                else
                    Array::Copy(state, 64, result, 0, m_hashSize);
            ...
            virtual void Finish() override
            {
                ...
                if (GetBufferPos() >= 120)
                {
                    TransformBytes(m_pad, 0, 128 - GetBufferPos());
                    Array::Clear(m_pad, 0, 120); // clear()
                }

                m_pad[120-GetBufferPos()] = (byte)bits;
                m_pad[121-GetBufferPos()] = (byte)(bits >> 8);
                m_pad[122-GetBufferPos()] = (byte)(bits >> 16);
                m_pad[123-GetBufferPos()] = (byte)(bits >> 24);
                m_pad[124-GetBufferPos()] = (byte)(bits >> 32);
                m_pad[125-GetBufferPos()] = (byte)(bits >> 40);
                m_pad[126-GetBufferPos()] = (byte)(bits >> 48);
                m_pad[127-GetBufferPos()] = (byte)(bits >> 56);
        ...
        public:
            ...
            BlueMidnightWish512Base(int a_hashSize)
                : BlueMidnightWishBase(a_hashSize)
            {
                m_buffer = gcnew Trans::HashBuffer(128);

                m_state = gcnew array<ulong>(32);
                m_pad = gcnew array<byte>(128);
