...
namespace Shabal
{
    ref class Shabal
    {
        ...
        private: Trans::HashBuffer^ m_buffer;
        private: array<uint>^ m_A;
        private: array<uint>^ m_B;
        private: array<uint>^ m_C;
        ...
        public: Shabal(int a_hashSize)
        {
            ...
            m_A = gcnew array<uint>(12);
            m_B = gcnew array<uint>(16);
            m_C = gcnew array<uint>(16);
            m_buffer = gcnew Trans::HashBuffer(64);

            Initialize();
        }

        protected: void TransformBlock(array<byte>^ a_data, int a_index)
        {
            ...
            array<uint>^ buffer = Converters::ConvertBytesToUInts(a_data, a_index, BlockSize);
        ...
        protected: void Finish()     
        {
            ...
            array<uint>^ buffer = Converters::ConvertBytesToUInts(m_buffer->GetBytes(), 0, BlockSize);
        ...
        protected: array<byte>^ GetResult()
        {
            ...
            Buffer::BlockCopy(m_B, 64-HashSize, result, 0, HashSize);
            return result;
        }
        ...
        public: void Initialize()  
        {
            switch (HashSize) 
            {
                case 28:
                    ...
                    Array::Copy(A_init_224, m_A, 12);
                    Array::Copy(B_init_224, m_B, 16);
                    Array::Copy(C_init_224, m_C, 16);
                    break;

                case 32:

                    Array::Copy(A_init_256, m_A, 12);
                    Array::Copy(B_init_256, m_B, 16);
                    Array::Copy(C_init_256, m_C, 16);
                    break;

                case 48:

                    Array::Copy(A_init_384, m_A, 12);
                    Array::Copy(B_init_384, m_B, 16);
                    Array::Copy(C_init_384, m_C, 16);
                    break;

                case 64:

                    Array::Copy(A_init_512, m_A, 12);
                    Array::Copy(B_init_512, m_B, 16);
                    Array::Copy(C_init_512, m_C, 16);
                    break;
            }
