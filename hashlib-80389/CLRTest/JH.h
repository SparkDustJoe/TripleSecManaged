...
namespace JH
{
    ref class JH
    {
        private:
            ...
            static array<ulong>^ s_bitslices =
            {
            ...
            static array<array<ulong>^>^ s_initial_states = 
            {
            ...
            {
                array<ulong>^ data = Converters::ConvertBytesToULongs(a_data, a_index, 64);
            ...
            void Finish()
            {
                ...
                {
                    m_buffer[m_processed_bytes % 64] = 1 << (7 - (bits % 8));
            ...
            {
                return TomanuExtensions::ArrayExtensions::SubArray(
                    Converters::ConvertULongsToBytes(m_state, 8, 8), 64 - HashSize, HashSize);
            }
        ...
        public:
            ...
            void Initialize() 
            {
                switch (HashSize)
                {
                    case 28: Array::Copy(s_initial_states[0], m_state, m_state->Length); break;
                    case 32: Array::Copy(s_initial_states[1], m_state, m_state->Length); break;
                    case 48: Array::Copy(s_initial_states[2], m_state, m_state->Length); break;
                    case 64: Array::Copy(s_initial_states[3], m_state, m_state->Length); break;
                }
