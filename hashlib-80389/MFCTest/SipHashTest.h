...
#include "SipHashOrg.h"
#include "SipHash.h"

namespace MFCTest
{
    class SipHashTest : public TestBaseNonCryptoWithKey
    {
        private:

            SipHash::SipHash* m_hash;
        ...
        protected: 
            ...
            virtual void SetKey(byte* a_key)
            {
                m_hash->SetKey(a_key);
            }

            virtual void GenerateKeys(byte*& a_keys, int& a_count)
            {
                a_keys = new byte[2 * 16];
    ...
    */
    ...
    void SipHashOrgTest()
    {
        SipHashOrg::u8 in[MAXLEN], out[8], k[16];
        ...
        {
            in[i] = i;
            SipHashOrg::crypto_auth(out, in, i, k);
