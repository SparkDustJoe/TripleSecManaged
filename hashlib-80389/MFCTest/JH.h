...
#pragma region Consts
    ...
    const ulong initial_states[4][16] =
    {
    ...
    class JH
    {
        protected:
            ...
            byte* GetResult()
            {
                ...
                switch (HashSize)
                {
                    case 28: memcpy(result, (byte*)m_state + 100, 28); break;
                    case 32: memcpy(result, (byte*)m_state + 96, 32); break;
                    case 48: memcpy(result, (byte*)m_state + 80, 48); break;
                    case 64: memcpy(result, (byte*)m_state + 64, 64); break;
                }
            ...
            void Finish()
            {
                ...
                {
                    m_buffer[m_processed_bytes % 64] = 0x80;
            ...
            void TransformBlock(byte* a_data, int a_index)
            {
                ...
                for (int r = 0; r < 42; r = r + 7)
                {
                    ...
                    m14 = ~m14;
                    m0 ^= ~m8 & bitslice[r * 4];
                    m2 ^= ~m10 & bitslice[r * 4 + 2];
                    t0 = bitslice[r * 4] ^ (m0 & m4);
                    t1 = bitslice[r * 4 + 2] ^ (m2 & m6);
                    m0 ^= m8 & m12;
                    m2 ^= m10 & m14;
                    m12 ^= ~m4 & m8;
                    m14 ^= ~m6 & m10;
                    ...
                    m13 = ~m13;
                    m15 = ~m15;
                    m1 ^= ~m9 & bitslice[r * 4 + 1];
                    m3 ^= ~m11 & bitslice[r * 4 + 1 + 2];
                    t0 = bitslice[r * 4 + 1] ^ (m1 & m5);
                    t1 = bitslice[r * 4 + 1 + 2] ^ (m3 & m7);
                    m1 ^= m9 & m13;
                    m3 ^= m11 & m15;
                    m13 ^= ~m5 & m9;
                    m15 ^= ~m7 & m11;
                    ...
                    m12 = ~m12;
                    m14 = ~m14;
                    m0 ^= ~m8 & bitslice[(r + 1) * 4];
                    m2 ^= ~m10 & bitslice[(r + 1) * 4 + 2];
                    t0 = bitslice[(r + 1) * 4] ^ (m0 & m4);
                    t1 = bitslice[(r + 1) * 4 + 2] ^ (m2 & m6);
                    m0 ^= m8 & m12;
                    m2 ^= m10 & m14;
                    m12 ^= ~m4 & m8;
                    m14 ^= ~m6 & m10;
                    ...
                    m13 = ~m13;
                    m15 = ~m15;
                    m1 ^= ~m9 & bitslice[(r + 1) * 4 + 1];
                    m3 ^= ~m11 & bitslice[(r + 1) * 4 + 1 + 2];
                    t0 = bitslice[(r + 1) * 4 + 1] ^ (m1 & m5);
                    t1 = bitslice[(r + 1) * 4 + 1 + 2] ^ (m3 & m7);
                    m1 ^= m9 & m13;
                    m3 ^= m11 & m15;
                    m13 ^= ~m5 & m9;
                    m15 ^= ~m7 & m11;
                    ...
                    m12 = ~m12;
                    m14 = ~m14;
                    m0 ^= ~m8 & bitslice[(r + 2) * 4];
                    m2 ^= ~m10 & bitslice[(r + 2) * 4 + 2];
                    t0 = bitslice[(r + 2) * 4] ^ (m0 & m4);
                    t1 = bitslice[(r + 2) * 4 + 2] ^ (m2 & m6);
                    m0 ^= m8 & m12;
                    m2 ^= m10 & m14;
                    m12 ^= ~m4 & m8;
                    m14 ^= ~m6 & m10;
                    ...
                    m13 = ~m13;
                    m15 = ~m15;
                    m1 ^= ~m9 & bitslice[(r + 2) * 4 + 1];
                    m3 ^= ~m11 & bitslice[(r + 2) * 4 + 1 + 2];
                    t0 = bitslice[(r + 2) * 4 + 1] ^ (m1 & m5);
                    t1 = bitslice[(r + 2) * 4 + 1 + 2] ^ (m3 & m7);
                    m1 ^= m9 & m13;
                    m3 ^= m11 & m15;
                    m13 ^= ~m5 & m9;
                    m15 ^= ~m7 & m11;
                    ...
                    m12 = ~m12;
                    m14 = ~m14;
                    m0 ^= ~m8 & bitslice[(r + 3) * 4];
                    m2 ^= ~m10 & bitslice[(r + 3) * 4 + 2];
                    t0 = bitslice[(r + 3) * 4] ^ (m0 & m4);
                    t1 = bitslice[(r + 3) * 4 + 2] ^ (m2 & m6);
                    m0 ^= m8 & m12;
                    m2 ^= m10 & m14;
                    m12 ^= ~m4 & m8;
                    m14 ^= ~m6 & m10;
                    ...
                    m13 = ~m13;
                    m15 = ~m15;
                    m1 ^= ~m9 & bitslice[(r + 3) * 4 + 1];
                    m3 ^= ~m11 & bitslice[(r + 3) * 4 + 1 + 2];
                    t0 = bitslice[(r + 3) * 4 + 1] ^ (m1 & m5);
                    t1 = bitslice[(r + 3) * 4 + 1 + 2] ^ (m3 & m7);
                    m1 ^= m9 & m13;
                    m3 ^= m11 & m15;
                    m13 ^= ~m5 & m9;
                    m15 ^= ~m7 & m11;
                    ...
                    m12 = ~m12;
                    m14 = ~m14;
                    m0 ^= ~m8 & bitslice[(r + 4) * 4];
                    m2 ^= ~m10 & bitslice[(r + 4) * 4 + 2];
                    t0 = bitslice[(r + 4) * 4] ^ (m0 & m4);
                    t1 = bitslice[(r + 4) * 4 + 2] ^ (m2 & m6);
                    m0 ^= m8 & m12;
                    m2 ^= m10 & m14;
                    m12 ^= ~m4 & m8;
                    m14 ^= ~m6 & m10;
                    ...
                    m13 = ~m13;
                    m15 = ~m15;
                    m1 ^= ~m9 & bitslice[(r + 4) * 4 + 1];
                    m3 ^= ~m11 & bitslice[(r + 4) * 4 + 1 + 2];
                    t0 = bitslice[(r + 4) * 4 + 1] ^ (m1 & m5);
                    t1 = bitslice[(r + 4) * 4 + 1 + 2] ^ (m3 & m7);
                    m1 ^= m9 & m13;
                    m3 ^= m11 & m15;
                    m13 ^= ~m5 & m9;
                    m15 ^= ~m7 & m11;
                    ...
                    m12 = ~m12;
                    m14 = ~m14;
                    m0 ^= ~m8 & bitslice[(r + 5) * 4];
                    m2 ^= ~m10 & bitslice[(r + 5) * 4 + 2];
                    t0 = bitslice[(r + 5) * 4] ^ (m0 & m4);
                    t1 = bitslice[(r + 5) * 4 + 2] ^ (m2 & m6);
                    m0 ^= m8 & m12;
                    m2 ^= m10 & m14;
                    m12 ^= ~m4 & m8;
                    m14 ^= ~m6 & m10;
                    ...
                    m13 = ~m13;
                    m15 = ~m15;
                    m1 ^= ~m9 & bitslice[(r + 5) * 4 + 1];
                    m3 ^= ~m11 & bitslice[(r + 5) * 4 + 1 + 2];
                    t0 = bitslice[(r + 5) * 4 + 1] ^ (m1 & m5);
                    t1 = bitslice[(r + 5) * 4 + 1 + 2] ^ (m3 & m7);
                    m1 ^= m9 & m13;
                    m3 ^= m11 & m15;
                    m13 ^= ~m5 & m9;
                    m15 ^= ~m7 & m11;
                    ...
                    m12 = ~m12;
                    m14 = ~m14;
                    m0 ^= ~m8 & bitslice[(r + 6) * 4];
                    m2 ^= ~m10 & bitslice[(r + 6) * 4 + 2];
                    t0 = bitslice[(r + 6) * 4] ^ (m0 & m4);
                    t1 = bitslice[(r + 6) * 4 + 2] ^ (m2 & m6);
                    m0 ^= m8 & m12;
                    m2 ^= m10 & m14;
                    m12 ^= ~m4 & m8;
                    m14 ^= ~m6 & m10;
                    ...
                    m13 = ~m13;
                    m15 = ~m15;
                    m1 ^= ~m9 & bitslice[(r + 6) * 4 + 1];
                    m3 ^= ~m11 & bitslice[(r + 6) * 4 + 1 + 2];
                    t0 = bitslice[(r + 6) * 4 + 1] ^ (m1 & m5);
                    t1 = bitslice[(r + 6) * 4 + 1 + 2] ^ (m3 & m7);
                    m1 ^= m9 & m13;
                    m3 ^= m11 & m15;
                    m13 ^= ~m5 & m9;
                    m15 ^= ~m7 & m11;
        ...
        public:
            ...
            void Initialize()
            {
                ...
                switch (HashSize)
                {
                    case 28: memcpy(m_state, initial_states[0], 128); break;
                    case 32: memcpy(m_state, initial_states[1], 128); break;
                    case 48: memcpy(m_state, initial_states[2], 128); break;
                    case 64: memcpy(m_state, initial_states[3], 128); break;
                }  
            }
            ...
            void TransformBytes(byte* a_data, int a_index, int a_length)
            {
                ...
                while ((j + 64 - 1) <= last)
                {
                    ...
                    m_processed_bytes += 64;
                    j += 64;
                }

                i = m_processed_bytes % 64;
                while (j <= last)
                {
                    m_buffer[i++] = a_data[j++];
                    m_processed_bytes++;
