...
namespace Echo
{
    ...
    class Echo256Base : public EchoBase
    {
        protected:
        ...
        public:
            ...
            virtual void Initialize()
            {
                ...
                for (int i=0; i<4; i++)
                    m_state[2*i] = HashSize * 8;
            }
    };

    class Echo512Base : public EchoBase
    {
        protected:
