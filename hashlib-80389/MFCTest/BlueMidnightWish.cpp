...
namespace BMW
{
    const uint initial_state_224[16] = 
    {   
    ...
    const uint initial_state_256[16] = 
    {   
    ...
    const ulong initial_state_384[16] = 
    {
    ...
    const ulong initial_state_512[16] = 
    {
    ...
    void BMW256Base::TransformBlock(byte* a_data, int a_index)
    {
        uint* data32 = (uint*)(a_data + a_index);

        uint p256_00 = m_state[0] ^ data32[0];
        uint p256_01 = m_state[1] ^ data32[1];
        uint p256_02 = m_state[2] ^ data32[2];
        uint p256_03 = m_state[3] ^ data32[3];
        uint p256_04 = m_state[4] ^ data32[4];
        uint p256_05 = m_state[5] ^ data32[5];
        uint p256_06 = m_state[6] ^ data32[6];
        uint p256_07 = m_state[7] ^ data32[7];
        uint p256_08 = m_state[8] ^ data32[8];
        uint p256_09 = m_state[9] ^ data32[9];
        uint p256_10 = m_state[10] ^ data32[10];
        uint p256_11 = m_state[11] ^ data32[11];
        uint p256_12 = m_state[12] ^ data32[12];
        uint p256_13 = m_state[13] ^ data32[13];
        uint p256_14 = m_state[14] ^ data32[14];
        uint p256_15 = m_state[15] ^ data32[15];

        uint td32_00 = (data32[0] << 1) | (data32[0] >> 31);
        uint td32_01 = (data32[1] << 2) | (data32[1] >> 30);
        uint td32_02 = (data32[2] << 3) | (data32[2] >> 29);
        uint td32_03 = (data32[3] << 4) | (data32[3] >> 28);
        uint td32_04 = (data32[4] << 5) | (data32[4] >> 27);
        uint td32_05 = (data32[5] << 6) | (data32[5] >> 26);
        uint td32_06 = (data32[6] << 7) | (data32[6] >> 25);
        uint td32_07 = (data32[7] << 8) | (data32[7] >> 24);
        uint td32_08 = (data32[8] << 9) | (data32[8] >> 23);
        uint td32_09 = (data32[9] << 10) | (data32[9] >> 22);
        uint td32_10 = (data32[10] << 11) | (data32[10] >> 21);
        uint td32_11 = (data32[11] << 12) | (data32[11] >> 20);
        uint td32_12 = (data32[12] << 13) | (data32[12] >> 19);
        uint td32_13 = (data32[13] << 14) | (data32[13] >> 18);
        uint td32_14 = (data32[14] << 15) | (data32[14] >> 17);
        uint td32_15 = (data32[15] << 16) | (data32[15] >> 16);
        ...
        m_state[0] = ((XH32 << 5) ^ (p256_16 >> 5) ^ data32[0]) + ( XL32 ^ p256_24 ^ p256_00);
        m_state[1] = ((XH32 >> 7) ^ (p256_17 << 8) ^ data32[1]) + ( XL32 ^ p256_25 ^ p256_01);
        m_state[2] = ((XH32 >> 5) ^ (p256_18 << 5) ^ data32[2]) + ( XL32 ^ p256_26 ^ p256_02);
        m_state[3] = ((XH32 >> 1) ^ (p256_19 << 5) ^ data32[3]) + ( XL32 ^ p256_27 ^ p256_03);
        m_state[4] = ((XH32 >> 3) ^ p256_20 ^ data32[4]) + ( XL32 ^ p256_28 ^ p256_04);
        m_state[5] = ((XH32 << 6) ^ (p256_21 >> 6) ^ data32[5]) + ( XL32 ^ p256_29 ^ p256_05);
        m_state[6] = ((XH32 >> 4) ^ (p256_22 << 6) ^ data32[6]) + ( XL32 ^ p256_30 ^ p256_06);
        m_state[7] = ((XH32 >> 11) ^ (p256_23 << 2) ^ data32[7]) + ( XL32 ^ p256_31 ^ p256_07);

        m_state[8] = ((m_state[4] << 9) | (m_state[4] >> 23)) + ( XH32 ^ p256_24 ^ data32[8]) + ((XL32 << 8) ^ p256_23 ^ p256_08);
        m_state[9] = ((m_state[5] << 10) | (m_state[5] >> 22)) + ( XH32 ^ p256_25 ^ data32[9]) + ((XL32 >> 6) ^ p256_16 ^ p256_09);
        m_state[10] = ((m_state[6] << 11) | (m_state[6] >> 21)) + ( XH32 ^ p256_26 ^ data32[10]) + ((XL32 << 6) ^ p256_17 ^ p256_10);
        m_state[11] = ((m_state[7] << 12) | (m_state[7] >> 20)) + ( XH32 ^ p256_27 ^ data32[11]) + ((XL32 << 4) ^ p256_18 ^ p256_11);
        m_state[12] = ((m_state[0] << 13) | (m_state[0] >> 19)) + ( XH32 ^ p256_28 ^ data32[12]) + ((XL32 >> 3) ^ p256_19 ^ p256_12);
        m_state[13] = ((m_state[1] << 14) | (m_state[1] >> 18)) + ( XH32 ^ p256_29 ^ data32[13]) + ((XL32 >> 4) ^ p256_20 ^ p256_13);
        m_state[14] = ((m_state[2] << 15) | (m_state[2] >> 17)) + ( XH32 ^ p256_30 ^ data32[14]) + ((XL32 >> 7) ^ p256_21 ^ p256_14);
        m_state[15] = ((m_state[3] << 16) | (m_state[3] >> 16)) + ( XH32 ^ p256_31 ^ data32[15]) + ((XL32 >> 2) ^ p256_22 ^ p256_15);
    }

    void BMW256Base::FinalCompression() 
    {
    ...
    void BMW512Base::TransformBlock(byte* a_data, int a_index)
    {
        ulong* data64 = (ulong*)(a_data + a_index);
        ulong* tp512 = m_state; 
        ulong* tdat64 = data64;

        ulong p512_00 = (*tp512++) ^ (*tdat64++);
        ulong p512_01 = (*tp512++) ^ (*tdat64++);
        ulong p512_02 = (*tp512++) ^ (*tdat64++);
        ulong p512_03 = (*tp512++) ^ (*tdat64++);
        ulong p512_04 = (*tp512++) ^ (*tdat64++);
        ulong p512_05 = (*tp512++) ^ (*tdat64++);
        ulong p512_06 = (*tp512++) ^ (*tdat64++);
        ulong p512_07 = (*tp512++) ^ (*tdat64++);
        ulong p512_08 = (*tp512++) ^ (*tdat64++);
        ulong p512_09 = (*tp512++) ^ (*tdat64++);
        ulong p512_10 = (*tp512++) ^ (*tdat64++);
        ulong p512_11 = (*tp512++) ^ (*tdat64++);
        ulong p512_12 = (*tp512++) ^ (*tdat64++);
        ulong p512_13 = (*tp512++) ^ (*tdat64++);
        ulong p512_14 = (*tp512++) ^ (*tdat64++);
        ulong p512_15 = (*tp512++) ^ (*tdat64++);

        ulong td64_00 = (data64[0] << 1) | (data64[0] >> 63);
        ulong td64_01 = (data64[1] << 2) | (data64[1] >> 62);
        ulong td64_02 = (data64[2] << 3) | (data64[2] >> 61);
        ulong td64_03 = (data64[3] << 4) | (data64[3] >> 60);
        ulong td64_04 = (data64[4] << 5) | (data64[4] >> 59);
        ulong td64_05 = (data64[5] << 6) | (data64[5] >> 58);
        ulong td64_06 = (data64[6] << 7) | (data64[6] >> 57);
        ulong td64_07 = (data64[7] << 8) | (data64[7] >> 56);
        ulong td64_08 = (data64[8] << 9) | (data64[8] >> 55);
        ulong td64_09 = (data64[9] << 10) | (data64[9] >> 54);
        ulong td64_10 = (data64[10] << 11) | (data64[10] >> 53);
        ulong td64_11 = (data64[11] << 12) | (data64[11] >> 52);
        ulong td64_12 = (data64[12] << 13) | (data64[12] >> 51);
        ulong td64_13 = (data64[13] << 14) | (data64[13] >> 50);
        ulong td64_14 = (data64[14] << 15) | (data64[14] >> 49);
        ulong td64_15 = (data64[15] << 16) | (data64[15] >> 48);
        ...
        m_state[0] = ((XH64 << 5) ^ (p512_16 >> 5) ^ data64[0]) + ( XL64 ^ p512_24 ^ p512_00);
        m_state[1] = ((XH64 >> 7) ^ (p512_17 << 8) ^ data64[1]) + ( XL64 ^ p512_25 ^ p512_01);
        m_state[2] = ((XH64 >> 5) ^ (p512_18 << 5) ^ data64[2]) + ( XL64 ^ p512_26 ^ p512_02);
        m_state[3] = ((XH64 >> 1) ^ (p512_19 << 5) ^ data64[3]) + ( XL64 ^ p512_27 ^ p512_03);
        m_state[4] = ((XH64 >> 3) ^ p512_20 ^ data64[4]) + ( XL64 ^ p512_28 ^ p512_04);
        m_state[5] = ((XH64 << 6) ^ (p512_21 >> 6) ^ data64[5]) + ( XL64 ^ p512_29 ^ p512_05);
        m_state[6] = ((XH64 >> 4) ^ (p512_22 << 6) ^ data64[6]) + ( XL64 ^ p512_30 ^ p512_06);
        m_state[7] = ((XH64 >> 11) ^ (p512_23 << 2) ^ data64[7]) + ( XL64 ^ p512_31 ^ p512_07);

        m_state[8] = ((m_state[4] << 9) | (m_state[4] >> 55)) + ( XH64 ^ p512_24 ^ data64[8]) + ((XL64 << 8) ^ p512_23 ^ p512_08);
        m_state[9] = ((m_state[5] << 10) | (m_state[5] >> 54)) + ( XH64 ^ p512_25 ^ data64[9]) + ((XL64 >> 6) ^ p512_16 ^ p512_09);
        m_state[10] = ((m_state[6] << 11) | (m_state[6] >> 53)) + ( XH64 ^ p512_26 ^ data64[10]) + ((XL64 << 6) ^ p512_17 ^ p512_10);
        m_state[11] = ((m_state[7] << 12) | (m_state[7] >> 52)) + ( XH64 ^ p512_27 ^ data64[11]) + ((XL64 << 4) ^ p512_18 ^ p512_11);
        m_state[12] = ((m_state[0] << 13) | (m_state[0] >> 51)) + ( XH64 ^ p512_28 ^ data64[12]) + ((XL64 >> 3) ^ p512_19 ^ p512_12);
        m_state[13] = ((m_state[1] << 14) | (m_state[1] >> 50)) + ( XH64 ^ p512_29 ^ data64[13]) + ((XL64 >> 4) ^ p512_20 ^ p512_13);
        m_state[14] = ((m_state[2] << 15) | (m_state[2] >> 49)) + ( XH64 ^ p512_30 ^ data64[14]) + ((XL64 >> 7) ^ p512_21 ^ p512_14);
        m_state[15] = ((m_state[3] << 16) | (m_state[3] >> 48)) + ( XH64 ^ p512_31 ^ data64[15]) + ((XL64 >> 2) ^ p512_22 ^ p512_15);
    }

    void BMW512Base::FinalCompression()
    {
        ulong* tp512 = m_state;
        ulong p512_00 = (*tp512++) ^ 0xaaaaaaaaaaaaaaa0;
        ulong p512_01 = (*tp512++) ^ 0xaaaaaaaaaaaaaaa1;
        ulong p512_02 = (*tp512++) ^ 0xaaaaaaaaaaaaaaa2;
        ulong p512_03 = (*tp512++) ^ 0xaaaaaaaaaaaaaaa3;
        ulong p512_04 = (*tp512++) ^ 0xaaaaaaaaaaaaaaa4;
        ulong p512_05 = (*tp512++) ^ 0xaaaaaaaaaaaaaaa5;
        ulong p512_06 = (*tp512++) ^ 0xaaaaaaaaaaaaaaa6;
        ulong p512_07 = (*tp512++) ^ 0xaaaaaaaaaaaaaaa7;
        ulong p512_08 = (*tp512++) ^ 0xaaaaaaaaaaaaaaa8;
        ulong p512_09 = (*tp512++) ^ 0xaaaaaaaaaaaaaaa9;
        ulong p512_10 = (*tp512++) ^ 0xaaaaaaaaaaaaaaaa;
        ulong p512_11 = (*tp512++) ^ 0xaaaaaaaaaaaaaaab;
        ulong p512_12 = (*tp512++) ^ 0xaaaaaaaaaaaaaaac;
        ulong p512_13 = (*tp512++) ^ 0xaaaaaaaaaaaaaaad;
        ulong p512_14 = (*tp512++) ^ 0xaaaaaaaaaaaaaaae;
        ulong p512_15 = (*tp512++) ^ 0xaaaaaaaaaaaaaaaf;
    ...
    void BMWBase::Initialize()
    {
        m_processedBytes = 0;
        m_buffer_pos = 0;
    }

    void BMW256Base::Initialize()
    {
        if (HashSize == 28)
            memcpy(m_state, initial_state_224, 16 * sizeof(uint));
        else
            memcpy(m_state, initial_state_256, 16 * sizeof(uint));

        BMWBase::Initialize();
    }

    void BMW512Base::Initialize()
    {
        if (HashSize == 48)
            memcpy(m_state, initial_state_384, 16 * sizeof(ulong));
        else
            memcpy(m_state, initial_state_512, 16 * sizeof(ulong));

        BMWBase::Initialize();
    }

    void BMWBase::TransformBytes(byte* a_data, int a_index, int a_length)
    {
        int last = a_length + a_index - 1;

        int j = a_index;
        while (m_buffer_pos < BlockSize && j <= last)
        {
            m_buffer[m_buffer_pos++] = a_data[j++];
            m_processedBytes++;
        }
        ...
        m_buffer_pos = m_processedBytes % 64;
        while (j <= last)
        {
            m_buffer[m_buffer_pos++] = a_data[j++];
            m_processedBytes++;
    ...
    void BMW256Base::Finish()
    {
        int databitlen;

        m_buffer[m_buffer_pos] = m_buffer[m_buffer_pos] & 0xff00 ^ 0x80;
        ulong* data64 = (ulong*)m_buffer;

        if (m_processedBytes % BlockSize < 56)
        {
            memset(m_buffer + m_buffer_pos + 1, 0, 55 - m_buffer_pos);
            databitlen = 512;
            data64[7] = m_processedBytes * 8;
        }
        else
        {
            memset(m_buffer + m_buffer_pos + 1, 0, 119 - m_buffer_pos);
            databitlen = 1024;
            data64[15] = m_processedBytes * 8;
        }

        uint* data32 = (uint*)m_buffer;
        uint* p256 = m_state;

        while (databitlen >= 512)
        {
            databitlen -= 512;
            TransformBlock((byte*)data32, 0);
            data32 += 16;
        }
    ...
    void BMW512Base::Finish()
    {
        int databitlen;

        m_buffer_pos = m_processedBytes % BlockSize;

        m_buffer[m_buffer_pos] = m_buffer[m_buffer_pos] & 0xff00 ^ 0x80;

        ulong* data64 = (ulong*)m_buffer;

        if (m_processedBytes % BlockSize < 120)
        {
            memset(m_buffer + m_buffer_pos + 1, 0, 119 - m_buffer_pos);
            databitlen = 1024;
            data64[15] = m_processedBytes * 8;
        ...
        {
            memset(m_buffer + m_buffer_pos + 1, 0, 247 - m_buffer_pos);
            databitlen = 2048;
            data64[31] = m_processedBytes * 8;
        }
    ...
    byte* BMW256Base::GetResult()
    {
        byte* hashval = new byte[HashSize];

        if (HashSize == 28)
            memcpy(hashval, m_state + 9, 28);
        else
            memcpy(hashval, m_state + 8, 32);

        return hashval;
    }

    byte* BMW512Base::GetResult()
    {
        byte* hashval = new byte[HashSize];

        if (HashSize == 48)
            memcpy(hashval, m_state + 10, 48);
        else
            memcpy(hashval, m_state + 8, 64);

        return hashval;
    }

    byte* BMWBase::ComputeBytes(byte* a_data, int a_length)
    {
        Initialize();
